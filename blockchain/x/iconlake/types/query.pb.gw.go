...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 0, 2, 1}, []string{"iconlake", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Account_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"iconlake", "account", "address"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_AccountAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 0, 2, 1}, []string{"iconlake", "account"}, "", runtime.AssumeColonVerbOpt(true)))
)
