...
func request_Query_NFT_0(ctx context.Context, marshaler runtime.Marshaler, client QueryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq nft.QueryNFTRequest
	var metadata runtime.ServerMetadata
...
var (
	...
	pattern_Query_NFT_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"iconlake", "icon", "nft", "class_id", "id"}, "", runtime.AssumeColonVerbOpt(true)))
