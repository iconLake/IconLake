...
export const MsgMintDropResponse = {
  encode(message: MsgMintDropResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.lastMintDropTime !== "") {
      writer.uint32(10).string(message.lastMintDropTime);
    }
    return writer;
  },
  ...
  fromJSON(object: any): MsgMintDropResponse {
    return { lastMintDropTime: isSet(object.lastMintDropTime) ? String(object.lastMintDropTime) : "" };
  },
