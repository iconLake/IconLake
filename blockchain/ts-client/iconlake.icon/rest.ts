 ...
 */
export interface IconQueryParamsResponse {
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryNFTs = (
    ...
    this.request<IconlakeiconQueryNFTsResponse, RpcStatus>({
   ...
   * @request GET:/iconlake/icon/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<IconQueryParamsResponse, RpcStatus>({
      path: `/iconlake/icon/params`,
      method: "GET",
      format: "json",
      ...params,
    });
