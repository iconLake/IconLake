...
export interface DropQueryGetInfoResponse {
  info?: DropInfo;
}
 ...
 */
export interface DropQueryParamsResponse {
...
/**
 * @title iconlake/drop/genesis.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryInfoAll = (
    ...
    this.request<DropQueryAllInfoResponse, RpcStatus>({
      path: `/iconlake/drop/info`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
  ...
  queryInfo = (address: string, params: RequestParams = {}) =>
    this.request<DropQueryGetInfoResponse, RpcStatus>({
      path: `/iconlake/drop/info/${address}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/iconlake/drop/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<DropQueryParamsResponse, RpcStatus>({
      path: `/iconlake/drop/params`,
      method: "GET",
      format: "json",
      ...params,
    });
